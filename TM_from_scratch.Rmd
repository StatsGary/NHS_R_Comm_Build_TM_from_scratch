...
The EDA component we will build sources an external function from the functions sub folder in our project structure. This function builds the `histoplotter` function to 
